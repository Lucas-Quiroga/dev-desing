  ...
  return (
    ...
    >
      ...
      <div className="grid lg:grid-cols-2 gap-x-5">
        ...
        <div>
          <h3
            className="text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl font-semibold text-offwhite mb-6 text-center sm:text-start mt-20 lg:mt-0"
            data-aos="zoom-in"
          >
            Sobre Nosotros
          </h3>
          <p
            ...
            data-aos="zoom-in"
          >
            En DevDesign, conformamos un equipo dedicado a impulsar a
            emprendedores y empresas hacia su siguiente nivel, manifestando en
            cada fase un proceso singular que eleva la marca a nuevas alturas.
            Nos comprometemos a expandir la presencia de tu negocio en el mundo
            digital, creando una experiencia que genere resultados positivos en
            la audiencia. Nos encargamos de diseñar y desarrollar la visibilidad
            de tu marca, buscando superar expectativas y causar un impacto
          ...
          <div className="flex justify-start gap-8 mx-auto items-center">
            ...
            >
              <a
                href="https://www.instagram.com/devdesign.ba/"
                target="_blank"
